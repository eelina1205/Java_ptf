...
public class AddNewUserTest {
    ...
    private void login(LoginData loginData) {
        ...
        wd.findElement(By.name("user")).sendKeys(loginData.getUser());
    ...
    public void addNewUserTest() {
        openFillForm();
        fillForm(new UserData("Yelena", "Yelina", "Korsakova", "Y.K.", "Test", "Book.com", "Minsk", "1234567890", "1234567890", "1234567890", "1234567890", "email1@gmail.com", "email2@gmail.com", "email3@gmail.com", "htttps://book.com", "2000", "2020", "Minsk2", "1234567789", "No notes"));
        returnToHomePage();
    }
    ...
    private void fillForm(UserData userData) {
        ...
        wd.findElement(By.name("nickname")).sendKeys(userData.getNic());
        ...
        wd.findElement(By.name("ayear")).sendKeys(userData.getAnniverYear());
